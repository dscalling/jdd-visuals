...
// Anfrageformular.
// Die Anfrage wird per POST an FormSubmit übermittelt.
// Dadurch öffnet sich auf dem Gerät des Kunden keine Mail-App.
document.querySelector("#projectForm").addEventListener("submit", () => {
  const button = document.querySelector("#projectForm .form-submit");
