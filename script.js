...
// ============================================================
// Wichtig: Das Kunden-Auto-Reply wird im EmailJS-Dashboard
// direkt mit dem Anfrage-Template verknüpft. Deshalb senden
// wir hier bewusst nur EIN Template.
emailjs.init({
...
projectForm.addEventListener("submit", async (event) => {
  ...
  try {
    ...
    // Eigene JDD-Visuals-Bestätigungsseite
    window.location.href = "./thanks.html";
  } catch (error) {
    console.error("EmailJS error:", error);
    formError.textContent =
      "Die Anfrage konnte gerade nicht gesendet werden. Bitte prüfe deine Angaben und versuche es erneut.";
